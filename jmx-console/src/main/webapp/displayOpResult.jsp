...
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
    <tr>
        <td height="105" align="center"><h1>JMX MBean Operation View</h1><%= hostname %>
        </td>
        <td height="105" align="center" width="300">
            <p>
                ...
                <input type="button" value="Back to MBean"
                       onClick="javascript:location='HtmlAdaptor?action=inspectMBean&amp;name=<%= request.getParameter("name") %>'"/>
            </p>
