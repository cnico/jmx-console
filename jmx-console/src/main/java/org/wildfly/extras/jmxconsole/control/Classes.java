...
import org.wildfly.extras.jmxconsole.html.HtmlAdaptorServlet;
...
public final class Classes
{
     ...
     *
     * <p>
     * This method attempts to locate a static method on the given class the attempts to invoke it with dummy arguments in the hope that the virtual machine
     * will prepare the class for the method call and call all of the static class initializers.
     *
    ...
    {
        if (type == null)
            throw new RuntimeException("Null argument type");
            ...
            throws ClassNotFoundException
    {
        ...
        /*Logger log = LoggerFactory.getLogger(Classes.class);
        
        log.trace("typeName " + typeName);
        log.trace("string class name " + String.class.getName());
        log.trace("string class name equals " + typeName.equals(String.class.getName()));*/
        
        if (typeName.equals(Boolean.TYPE.toString()) || typeName.equals(Boolean.class.getName()))
        {
            return Boolean.parseBoolean(text);
        }
        else if (typeName.equals(Short.TYPE.toString()) || typeName.equals(Short.class.getName()))
        {
            return Short.parseShort(text);
        }
        else if (typeName.equals(Integer.TYPE.toString()) || typeName.equals(Integer.class.getName()))
        {
            return Integer.parseInt(text);
        }
        else if (typeName.equals(Long.TYPE.toString()) || typeName.equals(Long.class.getName()))
        {
            return Long.parseLong(text);
        }
        else if (typeName.equals(Float.TYPE.toString()) || typeName.equals(Float.class.getName()))
        {
            return Float.parseFloat(text);
        }
        else if (typeName.equals(Double.TYPE.toString()) || typeName.equals(Double.class.getName()))
        {
            return Double.parseDouble(text);
        }
        else if (typeName.equals(Character.TYPE.toString()) || typeName.equals(Character.class.getName()))
        {
            return new Character(text.charAt(0));
        }
        else if (typeName.equals(Byte.TYPE.toString()) || typeName.equals(Byte.class.getName()))
        {
        ...
        throw new ClassNotFoundException("Only support primitives right now, " + typeName);
    ...
    /**
     * This method acts equivalently to invoking <code>Thread.currentThread().getContextClassLoader().loadClass(className);</code> but it also supports
     * primitive types and array classes of object types or primitive types.
     *
     * @param className the qualified name of the class or the name of primitive type or array in the same format as returned by the
    ...
    /**
     * This method acts equivalently to invoking classLoader.loadClass(className) but it also supports primitive types and array classes of object types or
     * primitive types.
     *
     * @param className the qualified name of the class or the name of primitive type or array in the same format as returned by the java.lang.Class.getName()
     *            method.
